...
#Added by emilio    
    def BLK_RADFRAC_Set_ReactionBeginStage(self, Blockname, InitialStage):
        self.BLK.Elements(Blockname).Elements("Input").Elements("REAC_STAGE1").Elements("#0").Value = InitialStage

    def BLK_RADFRAC_Set_ReactionEndingStage(self, Blockname, EndingStage):
        self.BLK.Elements(Blockname).Elements("Input").Elements("REAC_STAGE2").Elements("#0").Value = EndingStage    
    
    def BLK_RADFRAC_Set_HoldupBeginStage(self, Blockname, InitialStage):
        self.BLK.Elements(Blockname).Elements("Input").Elements("HOLD_STAGE1").Elements("#0").Value = InitialStage

    def BLK_RADFRAC_Set_HoldupEndingStage(self, Blockname, EndingStage):
        self.BLK.Elements(Blockname).Elements("Input").Elements("HOLD_STAGE2").Elements("#0").Value = EndingStage    
#End of added by emilio
