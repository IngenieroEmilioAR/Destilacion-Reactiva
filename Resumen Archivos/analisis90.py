...
simu =Simulation(AspenFileName= "destilacion reactiva evaluacion90.bkp", WorkingDirectoryPath= wd ,VISIBILITY=False)

stages = 90
simu.BLK_RADFRAC_Set_NSTAGE(BLOCKNAME, stages)
stages_2 = np.arange(1,stages-1,9)
print("etapas", stages)
for fraccion in fracciones:
    ...
    for i in range(len(stages_2)):
        ...
        stages_3 = np.arange(stages-1,stages_2[i],-9)
